<?php
/**
 * @file direction/signalement.php
 * Ce script représente la page d'affichage de signalements de l'espace de la direction de la santé Algérienne.
 *
 * @author FEGHOUL Celina
 */
include_once('includes/gestionSignalement.php');
session_start();
