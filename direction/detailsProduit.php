<?php
/**
 * @file direction/detailsProduit.php
 * Ce script représente la page de détails des produits que l'on va afficher à la direction.
 *
...
<body style="background-color: #E1EBEE;">
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top" >
    ...
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="#" style="margin-left: 15px;">SALAMATY<span style="color: green;margin-left: 5px ;">!</span></a><a class="navbar-brand me-5 fw-bold fs-3 h-font" href="#">Logo</a>
