<?php
/**
 *  @file specialiste/index.php
 * Ce script représente la page d'acceuil de l'espace du spécialiste.
 *
   ...
   <div class="container d-flex mt-5">
     <div class="row">
        <div class="col-md-6 mt-5">
           <span style="color: #2a52be; font-weight:bold; font-size:2.3rem;">Bienvenus,</span>
           <h3 style="font-weight:bold; font-size:1.9rem;">Dans votre espace spécialiste nutritionnel.</h3>
           <h6 class="mt-4" style="color: #696969;"> Dès à présent, vous avez accès à une multitude de fonctionnalités dans votre espace spécialiste nutritionnel. Explorez les produits fabriqués en Algérie, consultez les signalements de produits, et effectuez des études approfondies. Bonne exploration !</h6>
        </div>
        <div class="col-md-6 img-container">
            <img src="img/nutritonSpecialiste.png" alt="#"class="img-fluid">
        </div>
     </div>
   </div>
